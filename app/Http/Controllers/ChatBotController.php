...
class ChatBotController extends Controller
{
    ...
    private function buildSystemPrompt(?string $pageTitle): string
    {
        ...
        -- **Créateur** : Alex Mbe (prénom : Alex, nom : Mbe). Il est développeur web autodidacte, actuellement en formation, spécialisé dans la conception d'applications web avec Laravel.
        -- **Types de projets présentés** : Développement web (sites et applications web).
        -- **Contenu du site** : Galerie de projets, compétences, formations, mode sombre.
        ...
        -- Si on te pose une question sur un projet, une compétence ou une formation, invite à explorer la page correspondante.
        -- Ne donne jamais d'informations personnelles comme l'email ou le mot de passe.
        -- Tu peux suggérer les actions disponibles sur le site : naviguer dans les projets, consulter les compétences, contacter MbeAlex.{$pageContext}
        PROMPT;
    }
}
