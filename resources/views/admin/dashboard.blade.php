    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-xl p-5">
                <p class="text-2xl font-bold text-gray-900 dark:text-dark-text">{{ $stats['projects'] }}</p>
                <p class="text-sm text-gray-500 dark:text-dark-muted">Projets</p>
            </div>
            <div class="bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-xl p-5">
                <p class="text-2xl font-bold text-gray-900 dark:text-dark-text">{{ $stats['skills'] }}</p>
                <p class="text-sm text-gray-500 dark:text-dark-muted">Compétences</p>
            </div>
            <div class="bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-xl p-5">
                <p class="text-2xl font-bold text-gray-900 dark:text-dark-text">{{ $stats['formations'] }}</p>
                <p class="text-sm text-gray-500 dark:text-dark-muted">Formations</p>
            </div>
            <div class="bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-xl p-5">
