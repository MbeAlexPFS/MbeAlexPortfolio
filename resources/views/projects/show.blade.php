    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="mt-8">
            ...
            <div class="mt-8 flex flex-wrap gap-3">
                ...
                @endif
                @if($project->live_url)
                    <a href="{{ $project->github_pages_url }}" target="_blank" class="inline-flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-indigo-700 transition">
