...
@section('content')
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-gray-500 dark:text-dark-muted">Une sélection de mes développements web.</p>
                    </div>
    ...
    <section class="bg-white dark:bg-dark-card py-20 scroll-reveal">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-dark-text">Un projet en tête&nbsp;?</h2>
            <p class="mt-3 text-gray-500 dark:text-dark-muted max-w-xl mx-auto">
                N'hésitez pas à me contacter pour discuter de votre projet, une idée ou une collaboration.
            </p>
            <a href="{{ route('contact.show') }}" class="mt-8 inline-block bg-indigo-600 text-white px-5 py-3 rounded-lg font-medium hover:bg-indigo-700 transition">
                Me contacter
            </a>
        </div>
    </section>
