...
@section('content')
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <form method="POST" action="{{ route('auth.login') }}" class="mt-8 space-y-5">
            ...
            <button type="submit" class="w-full bg-indigo-600 text-white py-2.5 rounded-lg font-medium hover:bg-indigo-700 transition text-sm">
                Se connecter
            </button>
        </form>
        ...
        <div class="mt-6">
            <div class="relative">
                <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-200 dark:border-dark-border"></div></div>
                <div class="relative flex justify-center text-sm"><span class="bg-gray-50 dark:bg-dark-bg px-2 text-gray-500 dark:text-dark-muted">ou</span></div>
            </div>
            <a href="{{ route('auth.google') }}"
               class="mt-4 flex items-center justify-center gap-3 w-full border border-gray-300 dark:border-dark-border text-gray-700 dark:text-dark-muted py-2.5 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-dark-card transition text-sm">
        ...
        <p class="mt-6 text-center text-sm text-gray-500 dark:text-dark-muted">
            Pas encore de compte ? <a href="{{ route('auth.register') }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium">S'inscrire</a>
        </p>
    </div>
@endsection
